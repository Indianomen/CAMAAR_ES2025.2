...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { departamento: @professor.departamento, email: @professor.email, formacao: @professor.formacao, nome: @professor.nome, ocupacao: @professor.ocupacao, password_digest: @professor.password_digest, usuario: @professor.usuario } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { departamento: @professor.departamento, email: @professor.email, formacao: @professor.formacao, nome: @professor.nome, ocupacao: @professor.ocupacao, password_digest: @professor.password_digest, usuario: @professor.usuario } }
