...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference("Template.count") do
      post templates_url, params: { template: { administrador_id: @template.administrador_id, nome: @template.nome } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { administrador_id: @template.administrador_id, nome: @template.nome } }
