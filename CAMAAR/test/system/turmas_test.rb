...
class TurmasTest < ApplicationSystemTestCase
  ...
  test "should create turma" do
    ...
    fill_in "Disciplina", with: @turma.disciplina_id
    fill_in "Formulario", with: @turma.formulario_id
    fill_in "Horario", with: @turma.horario
    fill_in "Professor", with: @turma.professor_id
